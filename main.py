...
DATABASE_FILE = '/app/zabbix_messages.db'  # абсолютный путь внутри контейнера
PORT = int(os.environ.get('PORT', 8000))   # Timeweb использует порт 8000
...
def init_database():
    ...
    conn.commit()
    conn.close()
    print("✅ База данных SQLite создана/проверена")
